...
class BasePlugin:
    ...
    def __init__(self):
        ...
        now = datetime.now()
        self.LastTime = now
        self.lastTimeReset = now - timedelta(days=1)
    ...
    def onHeartbeat(self):
        ...
        Last-reset = self.lastTimeReset
        if now.date() > Last-reset.date():
        ...
        if self.EnergyImport <= 0:
            self.EnergyImport = 0
        strValue2 = str(self.EnergyImport) + ";12345"

        self.PVInject = (self.PVProd - self.EnergyCons)
        if self.PVInject <= 0:
            self.PVInject = 0
            self.PVCons = self.PVProd
            strValue4 = str(self.PVCons) + ";12345"

        else :
            self.PVCons = (self.PVProd - self.PVInject)
            strValue4 = str(self.PVCons) + ";12345"
        strValue5 = str(self.PVInject) + ";12345"
