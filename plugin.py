...
class BasePlugin:
    ...
    def readCons(self):
        ...
        nbKwh = len(listinKwH )
        if nbKwh > 0:
            self.TodayEnergyCons = round(sum(listinKwH ))
        else:
            Domoticz.Debug("No E Meter General cons found... ")
            noerror = False


        self.WriteLog("E Meter General cons calculated value is = {}w, and {}kwh".format(self.EnergyCons), (self.TodayEnergyCons), "Verbose")
        return noerror
