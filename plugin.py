...
class BasePlugin:
    ...
    # UPDATING DEVICES ------------------------------------------------------------------------------------------------
        ...
        self.WriteLog("Updating widget : Total Cons. {}w, PVProd {}, Import {}, PVCons {}, Inject {}, AutoCons {}, Co2 {}".format(strValue1, strValue3, strValue2, strValue4, strValue5, self.AutoCons, self.C02), "Verbose")
